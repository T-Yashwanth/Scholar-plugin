...
- No running head (student papers do not require one in APA 7)
...
- Two authors: use an ampersand inside parentheses, "and" in narrative text.
  Parenthetical: (Author & Author, Year). Narrative: Author and Author (Year).
...
- Using an ampersand in a narrative citation, where "and" is required
- Using "and" inside a parenthetical citation, where an ampersand is required
